Shader "Caio/Section5Challenge4"
{
	Properties{
		...
		SubShader{
			...
			CGPROGRAM
			#pragma surface surf BasicBlinnChallenge

			half4 LightingBasicBlinnChallenge(SurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
			{
